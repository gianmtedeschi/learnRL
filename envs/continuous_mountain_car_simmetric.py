...
class Continuous_MountainCarSimmEnv(gym.Env):
    """
    ## Description
    ...
    * v0: Initial versions release
    ...
    def __init__(self, horizon=200, gamma=1, render_mode: Optional[str] = None, goal_velocity=0):
        ...
        self.max_position = 2.3
        self.max_speed = 0.07
        self.goal_position = (
            0.52  # was 0.5 in gymnasium, 0.45 in Arnaud de Broissia's version
        )
    ...
    def reset(self, *, seed: Optional[int] = None, options: Optional[dict] = None):
        ...
        if options is None:
            ...
            low, high = utils.maybe_parse_reset_bounds(options, -1.2, 2.3)
