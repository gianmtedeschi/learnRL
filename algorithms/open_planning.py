"""Closed Loop Open Loop Planning Algorithm."""
# imports
import numpy as np
...
class CLOLPlanning:
    """This Class implements Closed Loop Open Loop Planning Algorithm using REINFORCE or GPOMDP."""
    def __init__(
